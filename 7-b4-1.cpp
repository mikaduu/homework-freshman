...
public:
	...
	double area()
	{
		double length1, length2, length3,p,s;
		length1 = sqrt((p1.getx() - p2.getx()) * (p1.getx() - p2.getx()) + (p1.gety() - p2.gety()) * (p1.gety() - p2.gety()));
		length2 = sqrt((p1.getx() - p3.getx()) * (p1.getx() - p3.getx()) + (p1.gety() - p3.gety()) * (p1.gety() - p3.gety()));
		length3 = sqrt((p2.getx() - p3.getx()) * (p2.getx() - p3.getx()) + (p2.gety() - p3.gety()) * (p2.gety() - p3.gety()));
