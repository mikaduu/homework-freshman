...
int menu()
{
	...
	printf("5.用I、J、K、L键控制上下左右(大小写均可，边界停止,按左箭头不向下移动)\n" );
	printf("6.用I、J、K、L键控制上下左右(大小写均可，边界回绕,按左箭头不向下移动)\n" );
	printf("0.退出\n");
	printf("[请选择0-6] ");
	ch = _getche();
	return ch;
...
{
	int input, x = 35, y = 9;//input表示从键盘读入的数据
...
{
	int input1, input2, x = 35, y = 9;//input表示从键盘读入的数据
